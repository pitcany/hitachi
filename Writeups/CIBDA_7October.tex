...
%	\par\noindent\rule{\textwidth}{0.4pt}
	...
	Figures 1 and 2 show the emission matrices. For emissions, two matrices are used -- one representing the means at each state (Figure 2) and one with variances (Figure 3).
...
%	
	...
	0.000 & 0.000994 & 0.999006 & 0.000 \\ 
	0.000 & 0.000 & 0.857 & 0.142 \\ 
	0.000 & 0.000 & 0.000 & 1.000 \\ 
	\end{array} \right)$
	
Previously, with standard HMM fitting without our new forward-backward updates, we were not estimating that state $3$ was an absorbing state as the probability of staying at $3$ was not estimated as $1$. Furthermore, when using our state constrained method, we have more stable estimates of the covariance.
...
\subsection*{Variational Autoencoders}
	...
	where $I$ is an indicator function. $c_1(4-s_t)$ is the cost of maintenance and $c_2(s_t)$ is the cost of being in a degraded state. $c_1$ and $c_2$ are constants that we set. In our case, we will set these to $c_1=50$ and $c_2=-50$.
